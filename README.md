...
## 4. 라이브러리 및 패키지 설치
  pip 최신 버전, 텐서플로우, 넘파이(버전 numpy tensorflow==2.4 numpy==1.19), opencv-python, Pyserial, imutils, openvino, openvino-dev(버전 2022.1.0) 등
  <br><br>
 ...
 - (BrainAI) C:\BrainAI>pip uninstall numpy
 - (BrainAI) C:\BrainAI>pip install numpy==1.19
